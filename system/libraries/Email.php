...
class CI_Email {
	...
	var	$smtp_host		= "smtp.mail.pcextreme.nl";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "info@thomashelling.nl";		// SMTP Username
	var	$smtp_pass		= "umlchecker";		// SMTP Password
