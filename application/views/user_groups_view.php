<!-- Main Content -->
	<div class="large-12 columns padding">
				...
				<a href="<?php echo $base_url;?>dashboard/insert_user_group">Insert New User Group</a>
				...
				<?php echo form_open(current_url());	?>  	
					<table>
						...
						<?php foreach ($user_groups as $group) { ?>
							<tr>
								<td>
									<a href="<?php echo $base_url;?>dashboard/update_user_group/<?php echo $group[$this->flexi_auth->db_column('user_group', 'id')];?>">
								...
								<td class="align_ctr">
									<a href="<?php echo $base_url.'dashboard/update_group_privileges/'.$group[$this->flexi_auth->db_column('user_group', 'id')];?>">Manage</a>
								</td>
								<td class="align_ctr">
