	...
	<div class="header">
		...
		<div class="row">
 			 ...
 			 <div class="large-3 columns koptekst">
 			 	<span> Welcome <a href="<?php echo $base_url;?>/dashboard/update_user_account/<?php echo $user['uacc_id']; ?>"><?php echo $user['upro_first_name'].' '.$user['upro_last_name']; ?></a></span> <br/> <br/>
